...
const BaseModalComponent = ({ className, children, onClose = () => { }, isLoading, backdrop = null }) => {
  ...
  return (
    ...
    >
      <div className="z-20 bg-gray-900 max-w-screen-2xl w-full sm:w-11/12 md:max-h-screen h-full sm:h-5/6 rounded-xl relative">
        ...
        <div className={clsx("flex flex-col w-full gap-y-4 absolute z-40 px-5 xs:px-10 lg:px-4 py-6 landscape-parent")} onKeyDown={handleKeyPress}>
